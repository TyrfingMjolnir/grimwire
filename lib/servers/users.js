...
module.exports = function() {
	...
	server.getStatus = function() {
		return {
			stream_num: Object.keys(streams.online_streams).length,
			stream_uris: Object.keys(streams.online_streams),
			online_user_num: Object.keys(streams.online_users).length,
			online_user_names: Object.keys(streams.online_users),
			online_users: streams.online_users
		};
	};
